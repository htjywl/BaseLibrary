...
public abstract class AbstractWheel extends View {
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        if (mViewAdapter instanceof AbstractWheelTextAdapter){
            ((AbstractWheelTextAdapter) mViewAdapter).setShowLineItem(index);
            invalidateItemsLayout(false);
        }
        int itemCount = mViewAdapter.getItemsCount();
    ...
    protected boolean rebuildItems() {
        ...
        mFirstItemIdx = first;
      /*  if (mViewAdapter != null&& mViewAdapter.getItemsCount() != 0 && mViewAdapter instanceof AbstractWheelTextAdapter) {
            ((AbstractWheelTextAdapter) mViewAdapter).setShowLineItem(mFirstItemIdx);
        }*/
        return updated;
    }
