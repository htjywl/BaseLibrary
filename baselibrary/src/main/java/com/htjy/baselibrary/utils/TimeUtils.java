...
public final class TimeUtils {
    ...
    public static final DateFormat TIME_FORMAT_1 = new SimpleDateFormat("yyyy年M月d日  HH:mm", Locale.getDefault());
    public static final DateFormat TIME_FORMAT_2 = new SimpleDateFormat("yyyy-MM-dd HH:mm", Locale.getDefault());
    public static final DateFormat TIME_FORMAT_3 = new SimpleDateFormat("HH点mm分", Locale.getDefault());
    public static final DateFormat TIME_FORMAT_4 = new SimpleDateFormat("yyyy年MM月dd日 EEEE", Locale.getDefault());
    public static final DateFormat TIME_FORMAT_5 = new SimpleDateFormat("HH : mm", Locale.getDefault());
